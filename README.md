...
===
My client-server tests: [![Build Status](https://travis-ci.org/CatInCosmicSpace/webdav-client-cpp.svg?branch=master)](https://travis-ci.org/CatInCosmicSpace/webdav-client-cpp)
===
